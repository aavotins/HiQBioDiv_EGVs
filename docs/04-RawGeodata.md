...
that its predictions of precipitation patterns are better [@CHELSA]. Data are freely 
available for download from [homepage](https://chelsa-climate.org/) forwarding 
...
extent of Latvia (using 1 km vector grid) and saves file for further processing 
