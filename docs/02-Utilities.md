...
this function needs only c.a. 5 GiBs of RAM per worked to perform tasks in this 
...
compact data.frame with per-layer stats and timing. Function can be used to run 
