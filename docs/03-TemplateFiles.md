...
in the [HiQBioDiv's Zenodo repository](https://zenodo.org/records/14277114). The command lines 
...
Appearance of file `pts300_r3000_NA.parquet`, i.e. without a tile number, is expected, 
...
in the [HiQBioDiv's Zenodo repository](https://zenodo.org/records/14497070). The command lines 
and data used to create these files are documented in 
