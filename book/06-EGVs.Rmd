...
```{r flowchart, echo=FALSE, out.width = '100%', fig.cap='Relationships of ecogeograpfical variables crated.'}
knitr::include_graphics("../Figures/EGV_FlowChartY_eps_krasains.png")
```
