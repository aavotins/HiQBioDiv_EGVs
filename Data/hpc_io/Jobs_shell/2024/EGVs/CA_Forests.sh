#!/bin/bash
#SBATCH --job-name=CA_Forests			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/CA_Forests.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Forests_radii.R"
