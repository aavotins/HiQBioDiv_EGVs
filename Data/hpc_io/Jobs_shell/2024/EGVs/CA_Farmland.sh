#!/bin/bash
#SBATCH --job-name=CA_Farm			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/CA_Farmland.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Farmland_radii.R"
