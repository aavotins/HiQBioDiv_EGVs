#!/bin/bash
#SBATCH --job-name=eFShTre			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/Egde_FarmlandShrubs-Trees.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Edges_FarmlandShrubs-Trees.R"
