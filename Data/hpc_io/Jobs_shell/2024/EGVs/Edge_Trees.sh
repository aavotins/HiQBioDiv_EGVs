#!/bin/bash
#SBATCH --job-name=eTrees			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/Egde_Trees.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Edges_Trees.R"
