#!/bin/bash
#SBATCH --job-name=eGrass			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/Egde_Grasslands.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Edges_Grasslands.R"
