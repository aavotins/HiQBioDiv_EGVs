#!/bin/bash
#SBATCH --job-name=eRSRWat			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/Egde_ReedSedgeRushBeds-Water.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Edges_ReedSedgeRushBeds-Water.R"
