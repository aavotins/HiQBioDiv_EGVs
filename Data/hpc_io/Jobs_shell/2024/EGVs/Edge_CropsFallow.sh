#!/bin/bash
#SBATCH --job-name=eCroFal			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/Egde_CropsFallow.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Edges_CropsFallow.R"
