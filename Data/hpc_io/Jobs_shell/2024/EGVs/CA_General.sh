#!/bin/bash
#SBATCH --job-name=CA_Gen			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/CA_General.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_General_radii.R"
