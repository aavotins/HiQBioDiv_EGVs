#!/bin/bash
#SBATCH --job-name=eBogTre			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/Egde_Bogs-Trees.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Egdes_Bogs-Trees.R"
