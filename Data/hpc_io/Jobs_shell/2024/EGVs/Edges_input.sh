#!/bin/bash
#SBATCH --job-name=EdgeInput			 # Job name
#SBATCH --partition=regular			 # Partition name
#SBATCH --ntasks=1				 # Number of tasks
#SBATCH --cpus-per-task=1
#SBATCH --mem=400G				 # Kopējā atmiņa
#SBATCH --time=80:00:00			 # Time limit, hrs:min:sec
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/Edges_input.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Edges_input.R"
