#!/bin/bash
#SBATCH --job-name=eFarBui			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/Egde_Farmland-Builtup.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Edges_Farmland-Builtup.R"
