#!/bin/bash
#SBATCH --job-name=eRoads			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/Edges_Roads.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Edges_Roads.R"
