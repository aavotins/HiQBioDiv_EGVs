#!/bin/bash
#SBATCH --job-name=Fore-cell			 # Job name
...
#SBATCH --output=hpc_io/Outfiles/2024/EGVs/Forests_cell.out			 # Standard output and error log
...
SCRIPT="${WORKDIR}/RScripts_final/egvs06_Forests_cell.R"
